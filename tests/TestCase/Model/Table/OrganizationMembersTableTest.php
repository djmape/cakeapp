...
class OrganizationMembersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('OrganizationMembers') ? [] : ['className' => OrganizationMembersTable::class];
        $this->OrganizationMembers = TableRegistry::getTableLocator()->get('OrganizationMembers', $config);
    }
