...
class UserActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_activity_reference_no' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'user_activity_id' => 1,
                'user_activity_timestamp' => 1578565207,
