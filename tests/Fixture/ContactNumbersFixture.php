...
class ContactNumbersFixture extends TestFixture
{
    ...
    public $fields = [
        'contact_number_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['contact_number_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
