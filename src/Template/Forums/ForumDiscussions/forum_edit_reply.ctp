<!-- src/Template/Users/index.ctp -->
        ...
        <div id="content" class="content forum-content">
            ...
            <!-- begin form --> 
            <?php echo $this->Form->create($reply,array('enctype'=>'multipart/form-data','data-parsley-validate' => true)); ?>
            <form class="form-horizontal" enctype="multipart/form-data">

                                <div class="form-group row m-b-15">
                                    <label class="col-md-2 col-form-label">Reply</label>
                                    <div class="col-md-10">
                                        <?php echo $this->Form->control('forum_reply_detail_content', array('style' => 'height: 200px','class' => 'form-control wysiwyg', 'label' => false, 'required' => false, 'default' => $reply->forum_reply_detail->forum_reply_detail_content )); ?>
                                    </div>
                                </div>
                <div class="form-group row m-b-15 pull-right">
                    <div class="col-md-9">
                        <?php echo $this->Form->button(__('Update Reply'), array('class' => 'btn btn-sm btn-yellow'));
                                              echo $this->Form->end();?>
                    </div>
                </div>
            </form>
