                            ...
                            <?php
                                        ...
                                        ?>
                                                <div id="reply-discussion-content" style="">
                                                    <?php echo $this->Html->link($parentReply->forum_parent_reply->user->username,array('prefix' => false,'controller' => 'Users','action'=>'userProfile', $parentReply->forum_parent_reply->user->username )) ?> wrote:
                                                    <br>
                                                    <q> 
                                                        <i>
                                                            <?= $parentReply->forum_parent_reply->forum_reply_detail->forum_reply_detail_content ?>
                                                        </i>
                                                    </q>
                                                </div>
                                        <?php
