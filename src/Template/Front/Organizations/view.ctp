...
<head>
	<meta charset="utf-8" />
	<title>PUPQC | <?= $organization->organization_name ?> </title>
		...
		<div class="row">
			<div class="col-md-12">
    			<h1 class="page-header" style="color: #7e0e09;">
						...
						<?php echo $this->Html->image("../webroot/img/upload/".$organization->organization_photo, array('style' => 'width:20%; height:20%; margin: 1%; float: right')); ?>
                        <p style="font-size: 14px"><b>Organization Type</b></p>
						...
						<p style="font-size: 14px"><?= $organization->organization_goal ?></p>
                        <?php
                            }
                        ?>
						...
						<p style="font-size: 14px"><?= $organization->organization_objective ?></p>
                        <?php
                            }
                        ?>
