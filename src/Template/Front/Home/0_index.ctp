  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-ride="carousel" style="height: 87%; width: 100%; margin: 0">
    ...
    <div class="carousel-inner" role="listbox" style="height: 650px">
      ...
      <div class="item active">
        <div class="view slidescss" style="background:url('webroot/img/pup-qc-84c.jpg')no-repeat fixed center;">
        </div>
      ...
      <div class="item">
        <div class="view slidescss" style="background:url('webroot/img/pup-qc-251c.jpg')no-repeat fixed center;">
        </div>
        <div class="carousel-caption">
          <h3 style="color: white">Polytechnic University of the Philippines</h3>
          <p>Quezon City</p>
      ...
      <div class="item">
        <div class="view slidescss" style="background:url('webroot/img/pup-qc-560c.jpg')no-repeat fixed center;">
        </div>
        <div class="carousel-caption">
          <h3 style="color: white">Polytechnic University of the Philippines</h3>
          <p>Quezon City</p>
      ...
      <div class="item">
        <div class="view slidescss" style="background:url('webroot/img/pup-qc-174c.jpg')no-repeat fixed center;">
        </div>
        <div class="carousel-caption">
          <h3 style="color: white">Polytechnic University of the Philippines</h3>
          <p>Quezon City</p>
