		...
		<div id="sidebar" class="sidebar" data-disable-slide-animation="true">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
              		<!-- Visit Website -->
              		<li>
                		<?php echo $this->Html->link('<i class="fa fa-bullhorn fw"></i><span>Announcements Website</span>',['prefix' => "front", 'controller' => 'Home','action'=>'index'],array('escape' => false)) ?>
              		</li>
              		<li>
                		<?php echo $this->Html->link('<i class="fa fa-star fw"></i><span>Events</span>',['prefix' => "front", 'controller' => 'Home','action'=>'index'],array('escape' => false)) ?>
              		</li>
              		<li>
                		<?php echo $this->Html->link('<i class="fa fa-users fw"></i><span>Members Website</span>',['prefix' => "front", 'controller' => 'Home','action'=>'index'],array('escape' => false)) ?>
              		</li>
