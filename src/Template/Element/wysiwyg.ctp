<?php echo $this->Html->css("../plugins/bootstrap-wysihtml5/src/bootstrap3-wysihtml5.css")?>
<?php echo $this->Html->css("../plugins/bootstrap-wysihtml5/dist/bootstrap3-wysihtml5.min.css")?>

<?php echo $this->Html->script("../plugins/bootstrap-wysihtml5/dist/bootstrap3-wysihtml5.all.min.js")?>
...
<li>
  <div class="btn-group">
    <a class="btn btn-default wysihtml5-command-active" data-wysihtml5-command="insertUnorderedList" title="Unordered list" tabindex="-1" href="javascript:;" unselectable="on">
...
</ul><textarea class="textarea form-control" id="wysihtml5" rows="12" placeholder="Enter text ..." ></textarea><input type="hidden" name="_wysihtml5_mode" value="1">
