...
<head>
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<?php echo $this->Html->script("../plugins/jquery-ui-1.12.1/external/jquery/jquery.js")?>
	<?php echo $this->Html->script("../plugins/jquery-ui-1.12.1/jquery-ui.js")?>
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-body">
						<?php
						    ...
						    echo $this->Form->control('title', array('class' => 'form-control','id' => 'title'));
						    echo $this->Form->control('body',array('class' => 'form-control', 'onclick' => 'showDateTimePicker()'));
						    echo $this->Form->control('event_start_date',array('type' => 'text', 'class' => 'form-control datetimepicker', 'id' => 'event_start_date'));
						    echo $this->Form->control('event_end_date',array('type' => 'text', 'class' => 'form-control datetimepicker', 'id' => 'event_end_date'));
						    echo $this->Form->control('tag_string', array('class' => 'form-control'));
						    echo $this->Form->button(__('Save Article'), array('class' => 'btn btn-sm btn-primary'));
						    echo $this->Form->end();
						?>
					</div>
			</div>
...
<!-- ================== END PAGE LEVEL JS ================== -->
	...
	<?php echo $this->Html->script("../plugins/bootstrap-eonasdan-datetimepicker/build/js/bootstrap-datetimepicker.min.js");
	echo $this->fetch('css'); 
