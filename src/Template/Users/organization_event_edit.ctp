<!-- src/Template/Admin/Announcements/index.ctp --> 
        ...
        <div id="content" class="content">
            ...
            <!-- begin form -->
            <?php  
                echo $this->Form->create($organizationEvent,array('enctype'=>'multipart/form-data','class'=>'form-horizontal'));
            ?>

            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Title</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_event_title', array('class' => 'form-control','label' => false)); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Description</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_event_body', array('style' => 'height: 200px','class' => 'form-control wysiwyg', 'label' => false, 'required' => false )); ?>
                </div>
            </div>
            <!-- begin start date -->
            <div class="form-group row m-b-15" style="margin-bottom: 20px;">
                ...
                <div class="col-md-4">
                    <div class="input-group date" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
                        <?php 
                            echo $this->Form->control('organization_event_start_date', array('type'=>'text','id' => 'datepicker-start','class' => 'form-control','label' => false));
                        ?>
                ...
                <div class="col-md-4">      
                    <div class="input-group bootstrap-timepicker">
                        <?php echo $this->Form->control('organization_event_start_time', array('type'=>'text','id' => 'timepicker-start','class' => 'form-control','label' => false)); ?>
            ...
            <div class="form-group row m-b-15" style="margin-bottom: 20px;">
                ...
                <div class="col-md-4">
                    <div class="input-group date" id="datepicker-disabled-past-end" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
                        <?php echo $this->Form->control('organization_event_end_date', array('type'=>'text','id' => 'datepicker-end','class' => 'form-control','label' => false)); ?>
                        <span class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </span>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="input-group bootstrap-timepicker">
                        <?php echo $this->Form->control('organization_event_end_time', array('type'=>'text','id' => 'timepicker-end','class' => 'form-control','label' => false,'default' => $organizationEvent->organization_event_end_time)); ?>
                        <span class="input-group-addon"><i class="fa fa-clock"></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_event_sponsors', array('class' => 'form-control', 'label' => false )); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Participants</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_event_participants', array('class' => 'form-control', 'label' => false )); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Location</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_event_location', array('class' => 'form-control', 'label' => false )); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-10">
                    <span class="btn btn-yellow fileinput-button">
                        ...
                        <span>Add image</span>
                        <?php echo $this->Form->control('organization_event_photo', array('id' => 'inputGroupFile01','type'=>'file','label' => false, 'required' => false));?>
                    </span>
            ...
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Members Only</label>
                    <?php echo $this->Form->control('organization_announcement_visibility_members_only', ['type' => 'checkbox', 'label' => false, 'checked' => true]); ?>
                </div>
            </div>
