<!-- src/Template/Admin/Announcements/announcement_add.ctp -->
        ...
        <div id="content" class="content">
            ...
            <?php
                echo $this->Form->create($organizationAnnouncement);
            ?>

            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Announcement Title</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_announcement_title', array('class' => 'form-control', 'label' => false)); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Content</label>
                <div class="col-md-12">
                    <?php echo $this->Form->control('organization_announcement_body', array('style' => 'height: 200px','class' => 'form-control wysiwyg', 'label' => false, 'required' => false)); ?>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-form-label">Members Only</label>
                    <?php echo $this->Form->control('organization_announcement_visibility_members_only', ['type' => 'checkbox', 'label' => false]); ?>
                </div>
            </div>
