            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            ...
                            echo $this->Form->control('about_description', array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_description ));
                            echo $this->Form->control('about_mission',array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_mission ));
                            echo $this->Form->control('about_vision', array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_vision ));
                            echo $this->Form->control('about_goals', array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_goals ));
                            echo $this->Form->control('about_objective', array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_objective ));
                            echo $this->Form->control('about_hymn', array('type' => 'textarea','class' => 'form-control',
                                'default'=> $row->about_hymn ));
