                            ...
                            <table id="data-table" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="data-table_info">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $organization_officer->organization->organization_name ?>
                                        </td>
                                        <td>
                                            <?= $this->Html->link($organization_officer->organization_officer_name, ['action' => 'edit', $organization_officer->organization_officer_id]) ?>
                                        </td>
                                        <td>
                                            <?= $organization_officer->organization_officers_position->officers_position_name ?>
                                        </td>
                                        <td>
                                            <?= $this->Html->link('Edit', ['action' => 'edit', $organization_officer->organization_officer_id]) ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
