                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('organization_id',$organizations, array('class' => 'form-control','label' => false,'default' => $organization_officer->organization_id  )); ?> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Officer Position</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('officers_position_id',$organization_officers_positions, array('class' => 'form-control','label' => false,'default' => $organization_officer->officers_position_id )); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Officer Name</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('organization_officer_name', array('class' => 'form-control','label' => false, 'default' => $organization_officer->organization_officer_name ));?> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <span class="btn btn-success fileinput-button">
                                            ...
                                            <span>Add image</span>
                                                <?php echo $this->Form->control('organization_officer_photo', array('type'=>'file','label' => false, 'required' => false));?>
                                        </span>
                                    </div>
                                </div>
                                </div>
