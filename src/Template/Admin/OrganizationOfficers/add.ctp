                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('organization_id',$organization, array('class' => 'form-control','label' => false )); ?> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('organization_officer_name', array('class' => 'form-control','label' => false ));?> 
                                    </div>
                                </div>
                                <div class="form-group">
