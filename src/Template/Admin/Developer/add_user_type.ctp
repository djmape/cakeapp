...
<head>
    ...
    <title> Dev Panel | Add user type </title>
<!-- Include Base CSS -->
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <?php echo $this->Flash->render(); ?>
                    <div class="panel-body">
                        <?php echo $this->Form->create($user_type,array('class'=>'form-horizontal')); ?>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-form-label">User Type Name</label>
                                    <div class="col-md-12">
                                        <?php echo $this->Form->control('user_type_name', array('class' => 'form-control', 'label' => false )); ?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <div class="pull-right" style="margin-right: 1%">
                                        <?php echo $this->Form->button(__('Add User Type'), array('class' => 'btn btn-sm btn-yellow'));
                                              echo $this->Form->end();
                                        ?>
                                    </div>
                                </div>
