...
<head>
    ...
    <title> Admin Panel | All Offices </title>
                                        ...
                                        <td>
                                            <div class="pull-right center-block">
                                                <button type="button" class="btn btn-yellow btn-sm">
                                                    ...
                                                    <?= $this->Html->link('View Officers', ['action' => 'positions', $office->office_id]) ?>
                                                </button>
                                                <button type="button" class="btn btn-info btn-sm">
                                                    <i class="fa fa-edit">
                                                    </i>
                                                    <?= $this->Html->link('Edit', ['action' => 'edit', $office->office_id]) ?>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $office->office_id ?> )">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                    Delete
                                                </button>
