        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php echo $this->Form->create($office_positions);?>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('office_position_priority', array('class' => 'form-control','label' => false,'type' => 'number', 'default' => $row->office_position_priority)); ?>
                                ...
                                <div class="form-group row m-b-15" style="margin-right: 1%">
                                    <div class="pull-right">
                                        <?php echo $this->Form->button(__('Update Office Position'), array('class' => 'btn btn-sm btn-yellow'));
                                              echo $this->Form->end();
                                        ?>
                                    </div>
                                </div>
