            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            ...
                            echo $this->Form->control('employee_position_name', array('class' => 'form-control'));
                            echo $this->Form->select('employee_position_priority',$priority, array('class' => 'form-control');
                            echo $this->Form->button(__('Save Article'), array('class' => 'btn btn-sm btn-primary','action' => 'add','employee'));
                            echo $this->Form->end();
                        ?>
                    </div>
            <!-- end panel-body -->
