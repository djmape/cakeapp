    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <div class="panel-heading ui-sortable-handle">
                ...
                <h4 class="panel-title">Employee Positions</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
            <div class="panel-body">                        
                        <?php
                            ...
                            echo $this->Form->create($employee_position);
                            ?>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Employee Type</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('employee_position_name', array('class' => 'form-control')); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Employee Type</label>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <div class="panel-heading ui-sortable-handle">
                ...
                <h4 class="panel-title">Organization Officers Position</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
            <div class="panel-body">
