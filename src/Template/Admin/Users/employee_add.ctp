<!-- src/Template/Admin/Users/employee_add.ctp -->
        ...
        <div id="content" class="content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_lastname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_lastname' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">First Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_firstname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_firstname' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Middle Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_middlename', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_middlename' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_username' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Position</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->select('user_employee_position_id',$employee_positions, array('class' => 'form-control','label' => false, 'disabled' => array(0), 'empty' => '-- Select Position --','default', 'required' => true  )); ?> 
                    </div>
                </div>
                <div class="form-group row m-b-15">
