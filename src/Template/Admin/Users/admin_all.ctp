...
<?php echo $this->Html->css("../plugins/DataTables/extensions/Responsive/css/responsive.bootstrap.min.css"); ?> 
    ...
    <div id="content" class="content">
        ...
        <div style="margin-bottom: 2%">
            <?= $this->Html->link('<i class="fa fa-plus"></i> Add Administrator', ['controller' => 'Users', 'action' => 'adminAdd'],['class' => 'btn btn-yellow btn-sm','escape' => false]) ?>
        </div>
		<!-- begin table -->
...
<script>
    ...
    function confirmDelete() {
        ...
        var targeturl = ' http://localhost' + '<?= \Cake\Routing\Router::url(["prefix" => "admin" ,"controller"=>"Users","action"=>"adminDelete"]); ?>';
        var redirectURL = ' http://localhost' + '<?= \Cake\Routing\Router::url(["prefix" => "admin" ,"controller"=>"Users","action"=>"adminAll"]); ?>';
        swal({
            title: "Are you sure?",
