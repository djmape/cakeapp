<!-- src/Template/Admin/Users/student_add.ctp -->
...
<?php echo $this->Html->css("../plugins/jquery-file-upload/css/jquery.fileupload-ui.css")?>
        ...
        <div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item">
                	<?php echo $this->Html->link('Users',['prefix' => "admin", 'controller' => 'Users','action'=>'studentAll']) ?>
              	</li>
                <li class="breadcrumb-item active">
                    <?php echo $this->Html->link('Add User',['prefix' => "admin", 'controller' => 'Users','action'=>'studentAdd']) ?>
                </li>
			</ol>
			<!-- end breadcrumb -->

			<!-- begin page-header -->
			<h1 class="page-header">Add User: Student</h1>
			<!-- end page-header -->
            ...
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_student_lastname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_lastname' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">First Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_student_firstname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_firstname' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Middle Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_student_middlename', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_middlename' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_username' ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_student_number', array('class' => 'form-control','label' => false,'data-parsley-validate' => true ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
...
<script>
    ...
    $('#student_username').on('click', function() {
        $('#student_username').val(($('#student_lastname').val() + $('#student_firstname').val() + $('#student_middlename').val()).toLowerCase());
    });
