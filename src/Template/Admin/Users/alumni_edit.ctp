...
<?php echo $this->Html->css("../plugins/jquery-file-upload/css/jquery.fileupload-ui.css")?>
        ...
        <div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Edit User: Alumni</h1>
			<!-- end page-header -->
            ...
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_alumni_lastname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'alumni_lastname','default' => $alumni->user_alumni_lastname ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">First Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_alumni_firstname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'alumni_firstname','default' => $alumni->user_alumni_firstname ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Middle Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_alumni_middlename', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'alumni_middlename','default' => $alumni->user_alumni_middlename ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Email</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('email', array('class' => 'form-control','label' => false,'data-parsley-validate' => true,'default' => $alumni->user->email ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Username</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_username','default' => $alumni->user->username ));?>
                    </div>
                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">Courses</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('course_id',$courses, array('class' => 'form-control','label' => false, 'disabled' => array(0), 'empty' => '-- Select Course --','default', 'required' => true,'default' => $alumni->course_id  )); ?> 
                                    </div>
                                </div>
                <div class="form-group row m-b-15">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        ...
                        <div id="img_contain" class="row m-b-15" style=" height: 150px; width: 150px; margin-right: 1%; padding: 0">
                            <?php echo $this->Html->image("../webroot/img/upload/".$alumni->user_alumni_photo, array('id' => 'img_preview','style' => 'width:100%; height:auto;','class' => 'center-block')); ?>
                        </div>
