        ...
        <div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item">
                	<?php echo $this->Html->link('Employees',['prefix' => "admin", 'controller' => 'Users','action'=>'employeesAll']) ?>
              	</li>
                <li class="breadcrumb-item active">
                    <?php echo $this->Html->link('Edit Employee',['prefix' => "admin", 'controller' => 'Users','action'=>'employeeEdit']) ?>
                </li>
			</ol>
			<!-- end breadcrumb -->
            ...
            <!-- begin form -->	
            <?php echo $this->Form->create($employee,array('enctype'=>'multipart/form-data','data-parsley-validate' => true)); ?>
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Last Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_lastname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_lastname','default' => $employee->user_employee_lastname ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">First Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_firstname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_firstname','default' => $employee->user_employee_firstname ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Middle Name</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('user_employee_middlename', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_middlename','default' => $employee->user_employee_middlename ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Email</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('email', array('class' => 'form-control','label' => false,'data-parsley-validate' => true,'default' => $employee->user->email ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Username</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->control('username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_username','default' => $employee->user->username ));?>
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    <label class="col-md-3 control-label">Position</label>
                    <div class="col-md-9">
                        <?php echo $this->Form->select('user_employee_position_id',$employee_positions, array('class' => 'form-control','label' => false, 'disabled' => array(0), 'empty' => '-- Select Position --','default', 'required' => true,'default' => $employee->user_employee_position_id  )); ?> 
                    </div>
                </div>
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <span class="btn btn-yellow fileinput-button row m-b-15">
                            ...
                            <span>Add image</span>
                            <?php echo $this->Form->control('user_employee_photo', array('id' => 'inputGroupFile01','type'=>'file','label' => false, 'required' => false));?>
                        </span>
                        <div id="img_contain" class="row m-b-15" style=" height: 150px; width: 150px; margin-right: 1%; padding: 0">
                            <?php echo $this->Html->image("../webroot/img/upload/".$employee->user_employee_photo, array('id' => 'img_preview','style' => 'width:100%; height:auto;','class' => 'center-block')); ?>
                        </div>
