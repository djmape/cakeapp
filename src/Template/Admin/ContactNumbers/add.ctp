...
<head>
    ...
    <title> Admin Panel | Add Contact Number </title>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            echo $this->Form->create($number, array('data-parsley-validate' => true));                            
                        ?>
                        ...
                        <div class="form-group row m-b-15" style="margin-right: 1%">
                            <div class="pull-right">
                                <?php echo $this->Form->button(__('<i class="fa fa-plus"></i>  Add Contact Number'), array('class' => 'btn btn-sm btn-yellow'));
                                      echo $this->Form->end();
                                ?>
                            </div>
                        </div>
