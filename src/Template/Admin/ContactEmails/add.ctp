...
<head>
    ...
    <title> Admin Panel | Add Email </title>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            echo $this->Form->create($email, array('data-parsley-validate' => true));                            
                        ?>
                        <div class="form-group row m-b-15">
                            <label class="col-md-3 control-label">Email</label>
                                <div class="col-md-9">
                                    <?php echo $this->Form->control('contact_email', array('class' => 'form-control', 'type' => 'email', 'label' => false, 'data-parsley-type' => 'email' ));?> 
                                </div>
                        </div>
                        <div class="form-group row m-b-15" style="margin-right: 1%">
                            <div class="pull-right">
                                <?php echo $this->Form->button(__('Add Email'), array('class' => 'btn btn-sm btn-yellow'));
                                      echo $this->Form->end();
                                ?>
                            </div>
                        </div>
