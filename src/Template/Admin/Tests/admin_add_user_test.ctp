		...
		<!-- end #content -->
			...
			<ol class="breadcrumb pull-right">
                ...
                <li class="breadcrumb-item active">
                    <?php echo $this->Html->link('Add User',['prefix' => "admin", 'controller' => 'Tests','action'=>'adminAddUserTest']) ?>
                </li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
		...
		<!-- Add Email -->
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data">
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('admin_lastname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_lastname' ));?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">First Name</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('admin_firstname', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_firstname' ));?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">Middle Name</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('admin_middlename', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_middlename' ));?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('admin_username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_username' ));?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
...
<!-- ================== END PAGE LEVEL JS ================== -->
    ...
    <script>
        ...
        function adminAddUserTest() {
            var $email = $('#email').val();

        	var targeturl = ' http://localhost' + '<?= \Cake\Routing\Router::url(["prefix" => "admin" ,"controller"=>"Tests","action"=>"adminAddUserTest"]); ?>';
