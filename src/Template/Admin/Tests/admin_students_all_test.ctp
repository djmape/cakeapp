        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="breadcrumb-item active">
                    <?php echo $this->Html->link('Students',['prefix' => "admin", 'controller' => 'Users','action'=>'adminAll']) ?>
                </li>
            </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            ...
            <div style="margin-bottom: 2%">
                <?= $this->Html->link('<i class="fa fa-plus"></i> Add Employee User', ['controller' => 'Tests', 'action' => 'adminStudentAddTest'],['class' => 'btn btn-yellow btn-sm','escape' => false]) ?>
            </div>
            <!-- begin table -->
                    ...
                    <tr class="odd gradeX" data-email-id="<?= $user->user_id ?>">
                        ...
                        <td>
                            <div class="center-block">
                                <?= $this->Html->link('<i class="fa fa-edit"></i> Edit', ['controller' => 'Tests', 'action' => 'adminStudentEditTest', $student->user_student_id],['class' => 'btn btn-yellow btn-sm','escape' => false,'title' => $student->user->email]) ?>
...
<script>
    ...
    function confirmDelete() {
        ...
        var redirectURL = ' http://localhost' + '<?= \Cake\Routing\Router::url(["prefix" => "admin" ,"controller"=>"Tests","action"=>"adminStudentsAllTest"]); ?>';
        swal({
            title: "Are you sure?",
