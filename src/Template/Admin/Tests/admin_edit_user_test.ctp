		...
		<!-- Add Email -->
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('admin_username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'admin_username','default' => $admin->admin_username ));?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
