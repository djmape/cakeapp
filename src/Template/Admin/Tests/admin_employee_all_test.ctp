...
<?php echo $this->Html->css("../plugins/jquery-file-upload/css/jquery.fileupload-ui.css")?>
        ...
        <div id="content" class="content">
            ...
            <div style="margin-bottom: 2%">
                <?= $this->Html->link('<i class="fa fa-plus"></i> Add Employee User', ['controller' => 'Tests', 'action' => 'adminEmployeeAddTest'],['class' => 'btn btn-yellow btn-sm','escape' => false]) ?>
            </div>
            <!-- begin table -->
                    ...
                    <tr class="odd gradeX" data-email-id="<?= $user->user_id ?>">
                        ...
                        <td>
                            <div class="center-block">
                                <?= $this->Html->link('<i class="fa fa-edit"></i> Edit', ['controller' => 'Tests', 'action' => 'employeeEdit', $employee->user_employee_id],['class' => 'btn btn-yellow btn-sm','escape' => false,'title' => $employee->user->email]) ?>
...
<script>
    ...
    function confirmDelete() {
        ...
        var redirectURL = ' http://localhost' + '<?= \Cake\Routing\Router::url(["prefix" => "admin" ,"controller"=>"Tests","action"=>"adminEmployeeAllTest"]); ?>';
        swal({
            title: "Are you sure?",
