                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->control('username', array('class' => 'form-control','label' => false,'data-parsley-validate' => true, 'id' => 'student_username','default' => $student->user->username ));?>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('user_employee_position_id',$courses, array('class' => 'form-control','label' => false, 'disabled' => array(0), 'empty' => '-- Select Course --','default', 'required' => true,'default' => $student->course_id  )); ?> 
                                    </div>
                                </div>
                <div class="form-group row m-b-15">
