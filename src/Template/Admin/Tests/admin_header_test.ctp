				...
				<ul class="nav">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
              				<!-- Employees -->
              				<li>
                    			<?php echo $this->Html->link('Employees',array('prefix' => "admin", 'controller' => 'Courses','action'=>'index')) ?>
                    		</li>
              				<!-- Students -->
						    <li>
						    	<?php echo $this->Html->link('Students',array('prefix' => "admin", 'controller' => 'Organizations','action'=>'index')) ?>
						    </li>
						</ul>
					</li>
					<!-- end Student section -->
