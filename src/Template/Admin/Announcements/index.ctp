...
<head>
    ...
    <title> Admin Panel | All Announcements </title>
                            ...
                            <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 30%px;">
                                            Content
                                        </th>
                                        ...
                                        <td>
                                            <div class="pull-right center-block">
                                                <button type="button" class="btn btn-info btn-sm">
                                                    ...
                                                    <?= $this->Html->link('Edit', ['action' => 'edit', $announcement->announcement_id]) ?>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $announcement->announcement_id ?> )">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                    Delete
                                                </button>  
