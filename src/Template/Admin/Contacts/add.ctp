            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            ...
                            echo $this->Form->control('officers_position_name', array('class' => 'form-control'));
                            echo $this->Form->select('officers_position_priority',$priority, array('class' => 'form-control'));
