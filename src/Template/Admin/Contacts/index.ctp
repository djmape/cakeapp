                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="data-table" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="data-table_info">
                                ...
                                <tbody>
                                    <?php foreach ($organization_officers_positions as $organization_officers_position): ?>
                                    <tr>
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm">
                                                ...
                                                <?= $this->Html->link('Edit', ['action' => 'delete', $organization_officers_position->officers_position_id, , ['confirm' => __('Confirm to delete this entry?'), 'class' => 'crose-btn hide-postlink']]) ?>
                                            </button>
