...
<head>
    ...
    <title> Admin Panel | Add Organization Officer Position </title>
            ...
            <!-- begin panel-body -->
                    <div class="panel-body">
                        <?php
                            ...
                            echo $this->Form->create($organization_officers_positions);
                            echo $this->Form->control('officers_position_name', array('class' => 'form-control','default' => $row->officers_position_name));
                            echo $this->Form->select('officers_position_priority',$priority, array('class' => 'form-control','default' => $row->officers_position_priority));
                            echo $this->Form->button(__('Save Officer Priority'), array('class' => 'btn btn-sm btn-primary'));
                            echo $this->Form->end();
                        ?>
                    </div>
            <!-- end panel-body -->
