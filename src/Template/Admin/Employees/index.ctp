                            ...
                            <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $employee->employee_position->employee_position_name ?>
                                        </td>
                                        <td>
                                                <button type="button" class="btn btn-info btn-sm">
                                                    <i class="fa fa-edit">
                                                    </i>
                                                    <?= $this->Html->link('Edit', ['action' => 'edit', $employee->employee_id]) ?>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $employee->employee_id ?> )">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                    Remove
                                                </button>
