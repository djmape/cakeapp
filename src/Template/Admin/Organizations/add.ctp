<!-- src/Template/Admin/Organizations/add.ctp --> 
            ...
            <div id="content" class="content">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->select('organization_type',$organization_type, array('class' => 'form-control','label' => false ));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_name', array('class' => 'form-control','label' => false ));
                        ?> 
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_acronym', array('class' => 'form-control','label' => false));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_mission', array('style' => 'height: 200px','class' => 'form-control wysiwyg','label' => false,'required' => false));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_vision', array('style' => 'height: 200px','class' => 'form-control wysiwyg','label' => false,'required' => false));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_goal', array('style' => 'height: 200px','class' => 'form-control wysiwyg','label' => false,'required' => false));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->Form->control('organization_objective', array('style' => 'height: 200px','class' => 'form-control wysiwyg','label' => false,'required' => false));
                        ?>
                    </div>
                </div>
                ...
                <div class=" form-group row m-b-15 pull-right" style="margin-right: 1%">
                    <?php
                        echo $this->Form->button(__('<i class="fa fa-plus"></i> Add Organization'), array('class' => 'btn btn-sm btn-yellow'));
                        echo $this->Form->end();
                    ?>
                </div>
            </div>
