...
<head>
    ...
    <title> Admin Panel | Edit Officer </title>
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('organization_name', array('type' => 'text','class' => 'form-control','label' => false, 'default' => $organizations->organization_name, 'disabled'  => true, 'style' => 'background-color: fff;background : none;')); ?> 
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('officer_lastname', array('class' => 'form-control','label' => false,'default' => $organization_officer->officer_lastname ));?> 
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">First Name</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('officer_firstname', array('class' => 'form-control','label' => false,'default' => $organization_officer->officer_firstname ));?> 
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">Middle Name</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('officer_middlename', array('class' => 'form-control','label' => false,'default' => $organization_officer->officer_middlename ));?> 
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div id="img_contain" class="col-md-2" style=" height: 150px; width: 150px; margin-right: 1%; padding: 0">
                                            <?php echo $this->Html->image("../webroot/img/upload/".$organization_officer->officer_photo, array('id' => 'img_preview','style' => 'width:100%; height:auto;','class' => 'center-block')); ?>
                                        </div>
