...
<head>
    ...
    <title> Admin Panel | Edit Organization Officer Position </title>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1" data-init="true">
            ...
            <div class="panel-heading ui-sortable-handle">
                            <h5>
                                ...
                                <b> Edit Organization Officer Position</b>
                            </h5>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        ?>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('officers_position_priority',$priority, array('class' => 'form-control','default' => $row->officers_position_priority)); ?>
                                    </div>
                                </div>
