                    ...
                    <div class="panel-body">
                        ...
                        ?>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo $this->Form->control('officers_position_name', array('class' => 'form-control','label' => false)); ?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-3 control-label">Priority</label>
                                    <div class="col-md-9">
                                        <?php echo $this->Form->select('officers_position_priority',$priority, array('class' => 'form-control')); ?>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15" style="margin-right: 1%">
                                    <div class="pull-right">
                                        <?php echo $this->Form->button(__('Save Officer Position'), array('class' => 'btn btn-sm btn-yellow'));
                                              echo $this->Form->end();
                                        ?>
                                    </div>
                                </div>
